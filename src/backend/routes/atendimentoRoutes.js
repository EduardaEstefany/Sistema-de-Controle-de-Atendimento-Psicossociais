/**
 * Rotas de Atendimentos - Definição das rotas da API
 ...
 * Função pura aplicada como middleware
 */
...
// Rotas extras para funcionalidades adicionais

/**
 * GET /atendimentos/tipo/:tipo - Busca atendimentos por tipo
 */
router.get('/atendimentos/tipo/:tipo', AtendimentoController.buscarPorTipo);
